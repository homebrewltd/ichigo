...
filtered_dataset = dataset.filter(
    lambda batch: [idx in list_index for idx in batch["index"]],
    batched=True,
    num_proc=64,
)
...
# Add tokens
llama_tokenizer = PreTrainedTokenizerFast.from_pretrained(
...
processed_dataset.save_to_disk(f"voice-part{args.part_id}")
